...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Alta de inventario para el almacen "{{ $almacen->title }}"</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(array('route' => 'inventario.store', 'method' => 'POST')) !!}
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('category_id', $categorias, [], array('class' => 'form-control', 'id' => 'categorias')) !!}
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
